...
namespace GuzabaPlatform\Settings;
...
class Component extends BaseComponent implements ComponentInterface, ComponentInitializationInterface
{
    ...
    protected const COMPONENT_NAME = "Settings";
    //https://components.platform.guzaba.org/component/{vendor}/{component}
    protected const COMPONENT_URL = 'https://components.platform.guzaba.org/component/guzaba-platform/settings';
    ...
    protected const ERROR_REFERENCE_URL = 'https://github.com/AzonMedia/component-settings/tree/master/docs/ErrorReference/';
